...
parser.add_argument('--input_channel', type=int, default=4, help='the number of input channel.')
parser.add_argument('--input_size', type=int, default=112, help='the size of input.')
parser.add_argument('--torch_model', default="/home/night/PycharmProjects/Picture_Classification/pytorch-image-models/checkpoints/Live_Detection/model_best.pth.tar")   # '/home/night/PycharmProjects/Picture_Classification/pytorch-image-models/checkpoints/face_mask/checkpoint-36.pth.tar'  # './checkpoints/train/20200319-182337-mobilenetv2_100-224/checkpoint-14.pth.tar'
parser.add_argument('--onnx_model', default="FaceAnti-Spoofing.onnx")    # "mobilenetv2.onnx"
parser.add_argument('--onnx_model_sim', default="FaceAnti-Spoofing-sim.onnx", help='Output ONNX simple model')
